...
#The following java stuff is lifted from MAINTAINER Anastas Dancha (tks)
...
#Okay, now we call the Minecraft server script
#ENTRYPOINT ["pwsh downloadAndRun-minecraft.ps1"]
CMD ["pwsh", "downloadAndRun-minecraft.ps1"]